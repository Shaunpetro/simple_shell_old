...
/**
 * add_node - inserts node to the start of list
...
/**
 * print_list_str - prints only the string of a linked list
 ...
 * @head: first node - address of pointer
